...
public class BoardPaging {
    ...
    public void makePagingHTML() {
        ...
        if(startPage > pageBlock) pagingHTML.append("[<a href='boardList.jsp?pg="+(startPage-1)+"'>이전</a>]");
        ...
        if(endPage < totalP) pagingHTML.append("[<a href='boardList.jsp?pg="+(endPage+1)+"'>다음</a>]");      
    }
