...
public class BoardPaging {
    ...
    public void makePagingHTML() {
        ...
        if(startPage > pageBlock) pagingHTML.append("[<a href='boardList.do?pg="+(startPage-1)+"'>이전</a>]");
        ...
        if(endPage < totalP) pagingHTML.append("[<a id = 'paging' href='boardList.do?pg="+(endPage+1)+"'>다음</a>]");      
    }
